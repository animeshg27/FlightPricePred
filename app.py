...
app = Flask(__name__)
model = pickle.load(open("flight_randfor.pkl",'rb'))
...
def predict():
    if request.method == "POST":
        ...
        prediction = model.predict([[Journey_day, Journey_month, Dep_hour, Dep_min,
                                     Arrival_hour,Arrival_min,dur_hour,dur_min,Total_stops,
                                     ...
                                     Vistara_Premium_economy, s_Chennai, s_Delhi,
                                     s_Kolkata, s_Mumbai, d_Cochin,
